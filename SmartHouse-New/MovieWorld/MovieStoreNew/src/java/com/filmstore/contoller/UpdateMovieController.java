...
@WebServlet(name = "UpdateMovieController", urlPatterns = {"/UpdateMovieController"})
public class UpdateMovieController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //reterive movie by title for updating the field
       try {
           ...
           movie.setReleasedate(request.getParameter("realaseDate"));
            ...
            System.out.println(movie.getId()+" is being updated");
            String message = service.addOrUpdateMovie(movie, "updateMovie");
            System.out.println(message+" akd");
            RequestDispatcher rd =request.getRequestDispatcher("admin/updateMovieForm.jsp?message="+message); 
